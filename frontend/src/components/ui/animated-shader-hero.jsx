...
const useShaderBackground = () => {
    ...
    // Default Shader Source - Updated for Blue/Purple theme
    ...
    void main(void) {
        ...
        for (float i=1.; i<12.; i++) {
            ...
            vec2 p=uv;
            float d=length(p);
            // Changed vec3(1,2,3) to vec3(0.1, 0.4, 1.0) for blueish tones
            col+=.00125/d*(cos(sin(i)*vec3(0.2, 0.5, 1.0))+1.);
            float b=noise(i+p+bg*1.731);
            col+=.002*b/length(max(p,vec2(b*p.x*.02,p.y)));
            // Changed mix colors to blue/purple/dark
            col=mix(col,vec3(bg*.1,bg*.05,bg*.2),d); 
        }
        O=vec4(col,1);
    }`;
            ...
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white pointer-events-none">
                ...
                <div className="text-center space-y-6 max-w-5xl mx-auto px-4 pointer-events-auto">
                    ...
                    <div className="space-y-2">
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-blue-300 via-purple-400 to-cyan-300 bg-clip-text text-transparent animate-fade-in-up animation-delay-200">
                            {headline.line1}
                        </h1>
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-cyan-300 via-blue-400 to-purple-400 bg-clip-text text-transparent animate-fade-in-up animation-delay-400">
                            {headline.line2}
                        </h1>
                    </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 animate-fade-in-up animation-delay-800">
                            {buttons.primary && (
                                <button
                                    ...
                                    className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/25"
                                >
