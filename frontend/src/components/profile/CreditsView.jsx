                ...
                <div className="flex-1 p-12 border-b lg:border-b-0 lg:border-r border-white/5 flex flex-col items-center justify-center relative">
                    <div className="w-full h-[320px] relative">
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center space-y-1">
                            <span className="text-white/40 font-medium uppercase text-xs tracking-widest">Uso de Créditos</span>
                            <div className="text-7xl font-bold tracking-tighter text-white">{Math.round(availableCredits)}</div>
                            <span className="text-white/50 font-medium text-lg">Disponível</span>
                        </div>
                ...
                <div className="w-full lg:w-[45%] p-10 space-y-10">
                    <div className="grid grid-cols-2 gap-8 mb-4">
                        <div className="space-y-1">
                            <span className="text-white/30 text-sm font-medium">Usado</span>
                            <div className="text-5xl font-bold text-white">{Math.round(creditsUsed)}</div>
                        </div>
                        <div className="space-y-1 relative">
                            <span className="text-white/30 text-sm font-medium">Total</span>
                            <div className="text-5xl font-bold text-white">{monthlyLimit}</div>
                    ...
                    <div className="space-y-6">
                        <div className="flex justify-between items-center">
                            <h4 className="text-lg font-bold text-white">Detalhes dos Créditos</h4>
                        ...
                        <div className="space-y-8">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex justify-between items-end mb-1">
                                            <span className="font-semibold text-white">Créditos da Assinatura</span>
                                            <span className="text-white font-bold">{Math.round(availableCredits)}<span className="text-white/30">/{monthlyLimit}</span></span>
                                        </div>
                                        <div className="h-2 w-full bg-white/5 rounded-full overflow-hidden">
                                            <div
                                                className="h-full bg-gradient-to-r from-purple-500 to-blue-500"
                                                style={{ width: `${monthlyLimit > 0 ? (availableCredits / monthlyLimit) * 100 : 0}%` }}
                                            ></div>
                                        </div>
                                        <div className="flex justify-between mt-2">
                                            <span className="text-white/30 text-xs font-medium uppercase tracking-tight">Renova mensalmente</span>
                                            <span className="text-white/30 text-xs font-medium uppercase tracking-tight capitalize">Plano {credits?.plan}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex justify-between items-end mb-1">
                                            <span className="font-semibold text-white/50">Créditos Adicionais</span>
                                        ...
                                        <div className="flex justify-between mt-2">
                                            <span className="text-white/10 text-xs font-medium uppercase tracking-tight">Sem expiração</span>
                                            <span className="text-white/10 text-xs font-medium uppercase tracking-tight">Sem expiração</span>
                                        </div>
                                    </div>
                                </div>
